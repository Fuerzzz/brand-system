...
import com.chinahitech.shop.bean.DeleteBrand;
...
//http://localhost:9528/brand/all
    ...
    @PostMapping("/delete")
    public Result delete(@RequestBody DeleteBrand deleteBrand) {
        int r = brandService.delete(deleteBrand.getId());
        return Result.ok();
    }
